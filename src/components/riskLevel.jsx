    ...
    <div className='space-y-3 pb-14 md:space-y-3 lg:pb-6 xl:pb-6 md:pb-12 '>
          ...
          <div className='flex space-x-4'>
            <div className='relative flex '>
              <div className='border-l-2 border-[#614283]  h-[110px] md:h-[43px] lg:h-[70px] xl:h-[89px] arrow'></div>
            </div>
          ...
          <div className='flex space-x-4'>
            <div className='relative flex '>
              <div className='border-l-2 border-[#614283] h-[119px] md:h-[45px] lg:h-[70px] xl:h-[89px] arrow'></div>
            </div>
            <div className='flex flex-col justify-center'>
